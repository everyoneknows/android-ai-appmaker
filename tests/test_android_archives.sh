...
cd "$tmp"
curl -fsSL --retry 3 -o platform.zip https://dl.google.com/android/repository/platform-34-ext7_r03.zip
printf '%s  %s\n' 16fdb74c55e59ae3ef52def135aec713508467bd56d7dabcd8c9be31fa8b20f3 platform.zip | sha256sum -c - >/dev/null
unzip -Z1 platform.zip > platform.list
grep -Fxq android-34/android.jar platform.list
