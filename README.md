...
```sh
curl -fsSL https://raw.githubusercontent.com/everyoneknows/android-ai-appmaker/adc456282fb4d8b00fcda587cdb6db56e1d2a161/setup.sh | APPMAKER_REF=adc456282fb4d8b00fcda587cdb6db56e1d2a161 bash
```
